...
class UnconnectedScarfPatternForm extends Component {
  constructor(props) {
    super(props);
    this.state = {
      type: "Scarf",
  ...
  componentDidMount = () => {
    if (this.props.id !== undefined) {
      ...
      this.setState({ ...chosenPattern.dataScarf });
    }
  };
      ...
      return (
        <div>
          ...
          <form className="pattern-form" onSubmit={this.handleSubmitPattern}>
            <input
              type="text"
              placeholder="Whose scarf are these?"
...
let ScarfPatternForm = connect(mapsStateToProps)(UnconnectedScarfPatternForm);
export default ScarfPatternForm;
